...
import ro.pub.cs.systems.eim.test.network.ClientThread;
import ro.pub.cs.systems.eim.test.network.ServerThread;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), informationType, valueTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valueTextView = (TextView)findViewById(R.id.bitcoin_value_text_view);
    }
